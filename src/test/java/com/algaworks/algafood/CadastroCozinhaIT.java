...
public class CadastroCozinhaIT {
	...
	@Before
	public void setUp() {
		// habilita os logs quando os testes falham.
	...
	@Test
	public void deveRetornaQuantidadeCorretaDeCozinha_QuandoConsultarCozinhas() {
		given().accept(ContentType.JSON).when().get().then().body("", hasSize(quantidadeCozinhasCadastradas));
	}

	@Test
	public void deveRetornarEstatus201_QuandoCadastrarCozinha() {
